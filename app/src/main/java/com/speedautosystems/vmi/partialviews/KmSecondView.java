 ...
 */
public class KmSecondView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialKmSecondBinding binding;


    public KmSecondView(PartialKmSecondBinding binding) {
