 ...
 */
public class ChargingFirstView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialChargingFirstBinding binding;


    public ChargingFirstView(PartialChargingFirstBinding binding) {
