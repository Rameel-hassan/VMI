 ...
 */
public class WorkshopView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialWorkshopBinding binding;


    public WorkshopView(PartialWorkshopBinding binding) {
