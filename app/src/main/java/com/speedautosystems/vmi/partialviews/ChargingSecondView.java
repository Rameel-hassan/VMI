 ...
 */
public class ChargingSecondView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialChargingSecondBinding binding;


    public ChargingSecondView(PartialChargingSecondBinding binding) {
