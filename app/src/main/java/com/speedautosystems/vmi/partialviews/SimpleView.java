 ...
 */
public class SimpleView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialSimpleBinding binding;


    public SimpleView(PartialSimpleBinding binding) {
