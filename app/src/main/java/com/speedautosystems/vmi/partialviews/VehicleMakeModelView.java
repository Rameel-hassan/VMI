 ...
 */
public class VehicleMakeModelView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialVehicleMakeModelBinding binding;


    public VehicleMakeModelView(PartialVehicleMakeModelBinding binding) {
