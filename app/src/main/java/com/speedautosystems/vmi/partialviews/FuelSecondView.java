 ...
 */
public class FuelSecondView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialFuelSecondBinding binding;


    public FuelSecondView(PartialFuelSecondBinding binding) {
