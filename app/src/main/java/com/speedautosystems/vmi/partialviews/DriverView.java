 ...
 */
public class DriverView extends RecyclerView.ViewHolder implements PartialViewInterface {
    public PartialDriverBinding binding;


    public DriverView(PartialDriverBinding binding) {
